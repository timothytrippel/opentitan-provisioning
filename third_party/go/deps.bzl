...
def go_packages_():
    ...
    go_repository(
        ...
        sum = "h1:vDzz5HXbWLJcqlKJRNZFPhs+4jCzxIoOz4c7gYIO4YI=",
        version = "v3.5.1",
    )
    ...
    go_repository(
        ...
        sum = "h1:u8risUH348DmLy2XD3krH/S3GWk2ljuCrs8V3hd4584=",
        version = "v3.5.1",
    )
    ...
    go_repository(
        ...
        sum = "h1:u9wrZcRj9TKh2VONWlCQc4JKRnKWzQ0BuxmEKbf7LmA=",
        version = "v3.5.1",
    )
    go_repository(
